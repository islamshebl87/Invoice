...
function App() {
  ...
  return (
    <>
      <div className="beta__tag bg-blue-900 ml-5 text-white font-bold text-xs uppercase tracking-widest py-2 px-8 rounded shadow border-2 border-blue-500 hover:bg-transparent hover:text-blue-500 transition-all duration-900">
            ...
            <div className="flex flex-col justify-center">
              <article className="md:grid grid-cols-2 gap-10">
                <div className="flex flex-col">
                  <label htmlFor="name">عقد بيع حصرى</label>
                  <input
                    type="text"
                    name="text"
                    id="name"
